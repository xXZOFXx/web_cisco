...
<html lang="es" dir="ltr">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1"><meta name="description" content="Hover Effect Ideas: Inspiration for subtle hover effects" />
          ...
          <img src="images/icon1.png" width="60" height="40" alt="">
              ...
              <div class="col-sm-8">
                  ...
                  <!--    <div class="col textos">
                          <h4>Soluciones FORTINET</h4>
                          <div class="parrafos">
                            <p>•  Advanced Threat Protection & Intelligence</p>
                            <p>•  Secure and segment the Network</p>
                            <p>•  Protect Web Applications</p>
                            <p>•  Protect Networks with IoT Deployments</p>
                            <p>•  Secure Enterprice Branch SD-WAN</p>
                            <p>•  Secure the Cloud</p>
                            <p>•  Improve Regulatory Compliance</p>
                            <p>•  Endpoint Protection</p>
                            <p>•  Secure Unified Access</p>
                            <p>•  Small Business Protection</p>
                          </div>
              ...
              <figure class="effect-apollo">
                  ...
                  <figcaption>
                      <h2>Next Generation firewalls</h2>
                          <p>  <button type="button" class="btn btn-secondary boton" data-toggle="modal" data-target="#mod1">Saber más</button></p>
                            </figcaption>
                                    ...
                                    <figure class="effect-apollo">
                                        <img src="images/malware.jpg" alt="img22"/>

                                        <figcaption>
                                          <h2>protección  avanzada contra malware</h2>
                                              <p>  <button type="button" class="btn btn-secondary boton" data-toggle="modal" data-target="#mod2">Saber más</button></p>
                                              </figcaption>
                            ...
                            <img src="images/CiscoUmbrella.jpg" alt="img22"/>
                                ...
                                <figcaption>
                                  <h2>Cisco Umbrella</h2>
                                      <p>  <button type="button" class="btn btn-secondary boton" data-toggle="modal" data-target="#mod3">Saber más</button></p>
                                          </figcaption>
                                  </figure>
                  </div>
        ...
        <div class="cuadro-lg">
              ...
              <figure class="effect-apollo lg" style="width:100%;">
                  <img src="images/meraki.jpg" alt="img22"/>
                      ...
                      <figcaption>
                        <h2>Cisco meraki cloud managed</h2>
                            <p>  <button type="button" class="btn btn-secondary boton" data-toggle="modal" data-target="#mod4">Saber más</button></p>
                                </figcaption>
                        </figure>
        </div>
          <div class="cuadro">
              <figure class="effect-apollo">
                <img src="images/endpoints.jpg" alt="img18"/>
                  ...
                  <figcaption>
                      <h2>Cisco AMP for Endpoints</h2>
                        <p>  <button type="button" class="btn btn-secondary boton" data-toggle="modal" data-target="#mod5">Saber más</button></p>
                      </figcaption>
              ...
              <figure class="effect-apollo">
                  <img src="images/network.jpg" alt="img22"/>

                <figcaption>
                  <h2>Cisco AMP for Networks</h2>
                    <p>  <button type="button" class="btn btn-secondary boton" data-toggle="modal" data-target="#mod6">Saber más</button></p>
                    </figcaption>
                </figure>
                </div>
            </div>
      ...
      <div class="col">
          ...
          <div class="cuadro">
              <figure class="effect-apollo">
                  ...
                  <figcaption>
                      <h2>Servicios de identidad de cisco</h2>
                          <p><button type="button" class="btn btn-secondary boton" data-toggle="modal" data-target="#mod7">Saber más</button></p></p>
                            </figcaption>
                                    ...
                                    <figure class="effect-apollo">
                                        <img src="images/security.jpg" alt="img22"/>

                                        <figcaption>
                                          <h2>Cisco Stealthwatch</h2>
                                              <p>  <button type="button" class="btn btn-secondary boton" data-toggle="modal" data-target="#mod8">Saber más</button></p>
                                              </figcaption>
    ...
    <div class="col">
        ...
        <div class="cuadro">
            <figure class="effect-apollo">
                ...
                <figcaption>
                    <h2>Cisco email security</h2>
                        <p><button type="button" class="btn btn-secondary boton" data-toggle="modal" data-target="#mod9">Saber más</button></p></p>
                          </figcaption>
                                  ...
                                  <figure class="effect-apollo">
                                      <img src="images/web-security.jpg" alt="img22"/>

                                      <figcaption>
                                        <h2>Seguridad Cisco web security</h2>
                                            <p>  <button type="button" class="btn btn-secondary boton" data-toggle="modal" data-target="#mod10">Saber más</button></p>
                                            </figcaption>
...
<!-- Modales  -->
<div class="modal fade" id="mod1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
...
<div class="modal fade" id="mod2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
...
<div class="modal fade" id="mod3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
...
<div class="modal fade" id="mod4" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
...
<div class="modal fade" id="mod5" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
...
<div class="modal fade" id="mod6" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
...
<div class="modal fade" id="mod7" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
...
<div class="modal fade" id="mod8" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
...
<div class="modal fade" id="mod9" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
...
<div class="modal fade" id="mod10" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
<div class="modal-dialog" role="document">
  <div class="modal-content">
    <div class="modal-header">
    ...
    <div class="modal-footer">
      <button type="button" class="btn btn-secondary" data-dismiss="modal">cerrar</button>
        ...
        <!-- hover       <div class="container-fluid" >
                ...
                <div class="hovereffect">
                    <img class="" src="images/services.png" height="250" width="350" >
                        <div class="overlay">
                            <h2>Servicios</h2>
            				<p>
            					<a href="servicios.html"> <img class="tarjeta" src="images/servicio.svg" height="250" width="350"> </a>
            				</p>
                        </div>
                </div>
                      ...
                      <div class=" col-md-3" >
                        ...
                        <div class="hovereffect">
                            <img class="" src="images/servicios.png"  height="250" width="350" alt="">
                                <div class="overlay">
                                    <h2>Soluciones tecnológicas</h2>
                    				<p>
                    					<a href="soluciones.html"><img  class="tarjeta" src="images/solucion.svg"></a>
                    				</p>
                                </div>
                        </div>
                      ...
                      <div class=" col-md-3" >
                        ...
                        <div class="hovereffect">
                            <img class="" src="images/certificaciones.png"  height="250" width="350" alt="">
                                <div class="overlay">
                                    <h2>Certificaciones</h2>
                            <p>
                              <a href="certificaciones.html">   <img class="tarjeta" src="images/certificado.svg" alt=""> </a>
                            </p>
                                </div>
                        </div>
                      </div>
                      <div class="col-md-3" >
                        ...
                        <div class="hovereffect">
                            <img class="" src="images/nosotros.png"  height="250" width="350" alt="">
                                <div class="overlay">
                                    <h2>Nosotros</h2>
                    				<p>
                    					<a href="nosotros.html"> <img class="tarjeta" src="images/grupo.svg" alt=""> </a>
                    				</p>
                                </div>
                        </div>
                      </div>
